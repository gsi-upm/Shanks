...
public class Simulation extends SimState {
    ...
    public Logger log = Logger.getLogger(Simulation.class.getName());
    ...
    public Simulation(long seed) {
        super(seed);
        log.fine("Simulation constructor ->");
    }
    ...
    /**
     * Set the probability to broke a device or a probability that an error
     * happens
     * 
     * @param prob
     */
    ...
    /**
     * Get the probability to broke a device or a probability that an error
     * happens
     * 
     * @return PROB_BROKEN
     */
     ...
     * 
     * @return devicesnetwork List which contains the different device of the
     *         scenario
     */
    public List<Device> createFTTH() {
        ...
        Splitter splitter1 = new Splitter("Splitter1", 0, 45,
                ScenarioDefinitions.SPLITTER1);
        Splitter splitter2 = new Splitter("Splitter2", 0, 45,
                ScenarioDefinitions.SPLITTER2);
        ...
        System.out.println("FTTH RECIEN CREADA NUMERO DEVICES: "
                + devicesnetwork.size());
    ...
    /**
     * A more complex FTTH scenario, in this case is not necessary a method
     * which make the connections, they are made in this method
     * 
     * @return devicesnetwork List with the different device that form the
     *         scenario
     */
    public List<Device> createPPP() {
        ...
        ONT ont3 = new ONT("ONT3", 0, 45, ScenarioDefinitions.ONT);
        ONT ont4 = new ONT("ONT4", 0, 45, ScenarioDefinitions.ONT);
        Splitter splitter1 = new Splitter("Splitter1", 0, 45,
                ScenarioDefinitions.SPLITTER1);
        Splitter splitter2a = new Splitter("Splitter2a", 0, 45,
                ScenarioDefinitions.SPLITTER2);
        Splitter splitter2b = new Splitter("Splitter2b", 0, 45,
                ScenarioDefinitions.SPLITTER2);
        Splitter splitter2c = new Splitter("Splitter2c", 0, 45,
                ScenarioDefinitions.SPLITTER2);
        Splitter splitter2d = new Splitter("Splitter2d", 0, 45,
                ScenarioDefinitions.SPLITTER2);
        situateDevice(olt, -400, 0, 0);
