...
public class FailureTestSimulation extends ShanksSimulation {
     ...
     */
    public FailureTestSimulation(long seed,
    ...
    public void addSteppables() {
        int conf = (new Integer(this.configuration.getProperty(FailureTestSimulation.CONFIGURATION))).intValue();
//        int conf = 1;
        switch (conf) {
        case 0:
