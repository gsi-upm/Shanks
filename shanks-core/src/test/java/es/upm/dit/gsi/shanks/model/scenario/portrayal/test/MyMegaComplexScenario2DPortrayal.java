...
public class MyMegaComplexScenario2DPortrayal extends ComplexScenario2DPortrayal {
    ...
    public void placeElements() {       
        ...
        this.situateDevice((Device)cs.getNetworkElement("MED1"), 135, 120);
    ...
    public void placeScenarios() throws DuplicatedPortrayalIDException,
        ...
        ComplexScenario cs = (ComplexScenario) this.getScenario();
        this.situateScenario(cs.getScenario("SuperComplexScenario1"), new Double2D(0,0), ShanksMath.ANGLE_0, ShanksMath.ANGLE_0, ShanksMath.ANGLE_0);
        this.situateScenario(cs.getScenario("SuperComplexScenario2"), new Double2D(270,0), ShanksMath.ANGLE_0, ShanksMath.ANGLE_180, ShanksMath.ANGLE_0);
    }
