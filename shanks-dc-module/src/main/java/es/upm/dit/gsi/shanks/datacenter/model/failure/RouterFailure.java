...
public class RouterFailure extends Failure{
	...
	public void addPossibleAffectedElements() {
		this.addPossibleAffectedProperties(Router.class, Router.PROPERTY_CONGESTION, 50.0);
	}
	...
	public boolean isResolved() {
		...
		for (NetworkElement e : affected){
			...
			if (state.containsKey(Router.STATUS_CONGESTED)){
				if(state.get(Router.STATUS_CONGESTED)){
					return false;
				}
			}
		}
