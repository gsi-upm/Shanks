...
public class OLTtoSplitter extends Link{
	...
	//TODO "Complicar" los metodos de comprobar properties y status con las caracteristicas reales
    public OLTtoSplitter(String id, String initialState, int capacity) throws UnsupportedNetworkElementStatusException {
