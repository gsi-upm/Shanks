 ...
 * 
 */
package es.upm.dit.gsi.shanks.hackerhan.model.adsl.element.link;
...
public class CopperPair extends Link {
    ...
    public void checkStatus() throws UnsupportedNetworkElementStatusException {
        ...
        if (reliability.equals("OK"))
            this.updateStatusTo(CopperPair.STATUS_OK, true);
        else
        	this.updateStatusTo(CopperPair.STATUS_BROKEN, true);
    }
}