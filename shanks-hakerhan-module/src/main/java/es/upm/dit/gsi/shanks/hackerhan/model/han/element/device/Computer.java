 ...
 * this simulation the computer device has only three possible states: - OFF -
 * OK - NOK OK and NOK which implies that the device is turned on.
 * 
 * Computer are used by Hackers and Users to access different content on the
 * Internet. So each of this agents actions let a trace to the computer in which
 * the operation was performed. Unless the hacker hide it or mask.
 * 
 * @author darofar
 * 
 */
