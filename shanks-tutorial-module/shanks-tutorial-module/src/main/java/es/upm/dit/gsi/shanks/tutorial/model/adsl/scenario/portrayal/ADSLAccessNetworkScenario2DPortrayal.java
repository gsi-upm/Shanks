package es.upm.dit.gsi.shanks.tutorial.model.adsl.scenario.portrayal;
...
//        linksPortrayal.setPortrayalForAll(new Link2DPortrayalChooser());
	...
	public void placeScenarios() throws DuplicatedPortrayalIDException,
        ...
        for (int i=0; i<8; i++){
        	if (i<3){
        		this.situateScenario(cs.getScenario("HAN"+i), new Double2D(0,i*100), ShanksMath.ANGLE_0, ShanksMath.ANGLE_0);
        	} else if(i==3){
        		this.situateScenario(cs.getScenario("HAN"+i), new Double2D(100,0), ShanksMath.ANGLE_90, ShanksMath.ANGLE_0);
        	} else if(i==4){
        		this.situateScenario(cs.getScenario("HAN"+i), new Double2D(100,200), ShanksMath.ANGLE_90, ShanksMath.ANGLE_0);
        	} else {
        		this.situateScenario(cs.getScenario("HAN"+i), new Double2D(200,(i-5)*100), ShanksMath.ANGLE_180, ShanksMath.ANGLE_0);
        	}
        }
	}
