...
public class WifiConnection extends Link {
	...
	public void checkStatus() throws UnsupportedNetworkElementStatusException {
		...
		if (interference > 0.2) {
			this.updateStatusTo(WifiConnection.STATUS_INTERFEARENCES);
		} else if (pklratio >= 0.2) {
			this.updateStatusTo(WifiConnection.STATUS_HIGH_BER);
		} else {
			this.updateStatusTo(WifiConnection.STATUS_OK);
		}
	}
