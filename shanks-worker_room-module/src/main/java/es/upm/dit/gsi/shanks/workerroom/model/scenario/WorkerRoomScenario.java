...
public class WorkerRoomScenario extends Scenario {
	...
	public void addNetworkElements()
		...
		this.addNetworkElement(links.get(links.size()-1));
	}

	@Override
	public void addPossibleEvents() {
		// this.addPossibleEventsOfNE(RouterFailure.class,
		// this.getNetworkElement("LANRouter"));
	}
	...
	public static void main(String[] args) throws SecurityException,
		...
		WorkerRoomSimulation sim = new WorkerRoomSimulation(
				...
				"WorkerRoomScenario", STATUS_NORMAL, scenarioProperties);
