 ...
 * 
 * Also, a user-made notification is a trace that keeps the value of certain 
 * field, variable or whatever it wants to save for consult later. In this case
 * a notification has the form:
 * 
...
public class Notification {
    ...
    public static final String ONE_SHOOT_EVENT_TYPE = "OneShoot";
    public static final String PERIODIC_EVENT_TYPE = "Periodic";
    public static final String PROBABILISTIC_EVENT_TYPE = "Probabilistic";
    public static final String ELEMENT_VALUE_TYPE = "ElementValue";
     ...
     */
    private Class<?> interaction = null;
     ...
     * @param target
     */
    public Notification(String id, String type, long when, Object source,
    ...
    public Notification(String id, Object source, Class<?> interaction,
        ...
        if (interaction.isAssignableFrom(OneShotEvent.class)) {
            this.type = Notification.ONE_SHOOT_EVENT_TYPE;
        } else if (interaction.isAssignableFrom(ProbabilisticEvent.class)) {
            this.type = Notification.PROBABILISTIC_EVENT_TYPE;
        } else if (interaction.isAssignableFrom(PeriodicEvent.class)) {
            this.type = Notification.PERIODIC_EVENT_TYPE;
        } 
    }
